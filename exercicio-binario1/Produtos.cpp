...
void Produtos::grava(ofstream &escrita)
{
    escrita.write((char *)this, sizeof(Produtos));
}
void Produtos::recupera(ifstream &leitura)
{
    leitura.read((char *)this, sizeof(Produtos));
}
